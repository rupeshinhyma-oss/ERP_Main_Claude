...
| **Inquiries**| `GET` | `/api/v1/inquiries` | List RFQs with status filtering | `inquiry.read` |
| **Inquiries**| `POST` | `/api/v1/inquiries` | Create new inquiry RFQ | `inquiry.create` |
...
| **Inquiries**| `POST` | `/api/v1/inquiries/{id}/generate-quote-link` | Generate tokenized quote portal link | `inquiry.action` |
| **Inquiries**| `POST` | `/api/v1/inquiries/{id}/ai-extract-quote` | Parse quote attachment with AI | `inquiry.action` |
| **Inquiries**| `GET` | `/api/v1/inquiries/{id}/compare-matrix` | Multi-vendor quote comparison table | `inquiry.read` |
